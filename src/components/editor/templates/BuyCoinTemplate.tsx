  ...
  return (
    <div className="w-full h-full flex flex-col bg-gradient-to-b from-purple-900 to-blue-900 text-white overflow-auto">
      ...
      <header className="w-full p-6 flex justify-between items-center border-b border-white/10">
        <div className="font-bold text-2xl" style={{ fontFamily: styles.headingFont }}>
          <EditableComponent initialText="CoinX" isHeading={true} />
        </div>
        <nav className="flex gap-6">
          <div className="cursor-pointer hover:text-purple-300 transition-colors">
            <EditableComponent initialText="Home" />
          </div>
          <div className="cursor-pointer hover:text-purple-300 transition-colors">
            <EditableComponent initialText="Features" />
          </div>
          <div className="cursor-pointer hover:text-purple-300 transition-colors">
            <EditableComponent initialText="Tokenomics" />
          </div>
          <div className="cursor-pointer hover:text-purple-300 transition-colors">
            <EditableComponent initialText="Roadmap" />
          </div>
        </nav>
      ...
      <section className="w-full px-6 py-12 flex flex-col items-center justify-center text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6" style={{ fontFamily: styles.headingFont }}>
          <EditableComponent initialText="Introducing CoinX Token" isHeading={true} />
        </h1>
        <p className="text-xl md:text-2xl max-w-2xl mb-8 text-purple-200">
          <EditableComponent initialText="The next generation cryptocurrency powering the future of decentralized finance" />
        </p>
      ...
      <section className="w-full px-6 py-12 bg-black/20">
        <h2 className="text-3xl font-bold mb-8 text-center" style={{ fontFamily: styles.headingFont }}>
          <EditableComponent initialText="Tokenomics" isHeading={true} />
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
            <h3 className="text-xl font-semibold mb-4">
              <EditableComponent initialText="Total Supply" isHeading={true} />
            </h3>
            <p className="text-3xl font-bold text-purple-300">
              <EditableComponent initialText="100,000,000" isHeading={true} />
            </p>
            <p className="mt-2 text-purple-200">
              <EditableComponent initialText="Fixed supply with no additional minting" />
            </p>
          </div>
          <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
            <h3 className="text-xl font-semibold mb-4">
              <EditableComponent initialText="Distribution" isHeading={true} />
            </h3>
            <p className="text-3xl font-bold text-purple-300">
              <EditableComponent initialText="Fair Launch" isHeading={true} />
            </p>
            <p className="mt-2 text-purple-200">
              <EditableComponent initialText="40% public sale, 30% ecosystem, 20% team, 10% reserves" />
            </p>
          </div>
          <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
            <h3 className="text-xl font-semibold mb-4">
              <EditableComponent initialText="Token Utility" isHeading={true} />
            </h3>
            <p className="text-3xl font-bold text-purple-300">
              <EditableComponent initialText="Governance" isHeading={true} />
            </p>
            <p className="mt-2 text-purple-200">
              <EditableComponent initialText="Voting rights, platform discounts, staking rewards" />
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="w-full p-6 bg-black/30 border-t border-white/10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="font-bold text-xl mb-4 md:mb-0" style={{ fontFamily: styles.headingFont }}>
            <EditableComponent initialText="CoinX" isHeading={true} />
          </div>
          <div className="flex gap-4 mb-4 md:mb-0">
            ...
            <div className="cursor-pointer hover:text-purple-300 transition-colors">
              <EditableComponent initialText="Docs" />
            </div>
            <div className="cursor-pointer hover:text-purple-300 transition-colors">
          ...
          <div className="text-sm text-purple-200">
            <EditableComponent initialText="© 2023 CoinX. All rights reserved." />
          </div>
        </div>
      </footer>
    </div>
