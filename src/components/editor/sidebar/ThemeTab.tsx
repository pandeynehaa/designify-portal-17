    ...
    <div className="p-4 border-t border-cv-lightgray">
      <div className="bg-cv-gray p-3 rounded-md">
        ...
        <div className="flex items-center space-x-2 mb-4">
          <div className="w-6 h-6 rounded-full bg-cv-purple"></div>
          <div className="w-6 h-6 rounded-full bg-cv-purple/70"></div>
          <div className="w-6 h-6 rounded-full bg-cv-lightgray"></div>
          <div className="w-6 h-6 rounded-full bg-cv-white"></div>
        </div>
        <button className="w-full py-1.5 px-3 bg-cv-purple text-cv-white rounded-md text-sm font-medium hover:bg-cv-purple/90 transition-colors">
          Edit Theme
        </button>
      </div>
    </div>
